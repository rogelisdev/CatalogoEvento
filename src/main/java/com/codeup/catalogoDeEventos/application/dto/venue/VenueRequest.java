...
public class VenueRequest {
    ...
    @Schema(description = "The name of the venue", example = "La Casa del Pollo", required = true)
    private String name;

    @NotBlank(message = "Address is required")
    @Size(min = 3, max = 30, message = "The address must contain between 3 and 30 characters")
    @Schema(description = "Venue address", example = "K2 #10-100", required = true)
    private String address;

    @NotBlank(message = "City is required")
    @Size(min = 3, max = 50, message = "The city must contain between 3 and 50 characters")
    @Schema(description = "City where the venue is located", example = "Bogota", required = true)
    private String city;

    @NotBlank(message = "Country is required")
    @Size(min = 3, max = 100, message = "The country must contain between 3 and 100 characters")
    @Schema(description = "Country of the venue", example = "Colombia", required = true)
